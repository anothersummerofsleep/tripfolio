...
export const SEEDS = {
  ...
  'rates-cache': {},
  policies: [],
  // AI agents the user has connected (Claude Code, Cowork, custom). A record
  // of what's set up; the connection recipe + /api/agent-manifest are how they
  // actually use tripfolio.
  agents: [],
  settings: {
    homeCurrency: 'SGD',
